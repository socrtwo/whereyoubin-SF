...
system("cp images/us_self.png images/save.png");
...
if ($_POST['printText'])
{
	...
	#$backgroundsemi  = imagecolorallocatealpha($im, 255, 255, 255, 0);
	$backgroundfull  = imagecolorallocatealpha($im, 255, 255, 255, 1);
...
if ($me == 'y'){
$me_color = imagecolorallocate($im, 0,	38,	122);
