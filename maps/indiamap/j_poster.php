...
$pdf->SetAuthor('indiamap.wherehaveibeen.info user');
...
$pdf->Image('images/poster.png', 22, 22, $posterwidth, $posterheight, 'PNG', 'http://indiamap.wherehaveibeen.info', 'center', false, 300, 'center');
