...
$pdf->SetAuthor('africamap.wherehaveibeen.info user');
$pdf->SetTitle('Where I Have Visited in Africa');
$pdf->SetSubject('Africa Map PNG-PDF Conversion Test');
$pdf->SetKeywords('map of Africa, Africa, travelogue, PDF, travel');
$pdf->SetMargins(PDF_MARGIN_LEFT, PDF_MARGIN_TOP, PDF_MARGIN_RIGHT);
$pdf->AddPage();
$posterwidth = imagesx('images/poster.png');
$posterheight = imagesy('images/poster.png');
$pdf->Image('images/poster.png', 22, 22, $posterwidth, $posterheight, 'PNG', 'http://africamap.wherehaveibeen.info', 'center', false, 300, 'center');
