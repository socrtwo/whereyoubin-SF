/* OnLoad function */
function JdOnLoad(){
	document.getElementById("africa_map").src = "j_countries_load.php";
...
function onBoxClicked2(frame, country) {
	if(document.getElementById(country).checked == false) { 
		...
		document.getElementById("africa_map").src = "j_countries_load.php?action=add&country="+country;
		}
	else { 
		var newcount = parseInt(document.getElementById('Count').innerHTML)-1;
		if(newcount == 0) { newcount = newcount+' countries'; }
		...
		document.getElementById("africa_map").src = "j_countries_load.php?action=remove&country="+country;
		}
